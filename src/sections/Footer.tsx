          ...
          <div className="text-center md:text-left">
            ...
            <div className="mt-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex min-h-12 items-center justify-center rounded-lg bg-white px-5 py-3 font-medium text-black transition duration-300 hover:-translate-y-0.5 hover:bg-[#fff1f1] hover:shadow-[0_6px_20px_rgba(0,0,0,0.25)]"
              >
            ...
            <ul className="mt-5 flex justify-center gap-3 md:justify-start">
              <li>
                <a
                  ...
                  className="inline-flex items-center justify-center transition duration-200 hover:-translate-y-0.5 hover:text-white"
                >
                  <InstaIcon />
                </a>
              </li>
